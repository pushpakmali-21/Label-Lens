...
async def process_scan_stub(image_base64: str) -> tuple[dict, list, list, str, str]:
    """
    Stub vision pipeline for Sprint 1.
    Instead of running YOLO + PaddleOCR, it mocks the extraction.
    Returns: (extracted_data, fields, violations, verdict, verdictNote)
    """
    
    # Mocking what the ML models would extract
    extracted_data = {
