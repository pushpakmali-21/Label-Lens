              ...
              <div className="flex items-center gap-3 flex-wrap">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="bg-[#0E1A26] border border-[#26394B] rounded px-3 py-2 text-sm font-mono text-[#EDEAE1] w-32 focus:border-[#C9A15A] focus:outline-none"
                  />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0E1A26] border border-[#26394B] rounded px-2.5 py-1.5 text-xs text-[#EDEAE1] focus:border-[#C9A15A] focus:outline-none"
                />
              </div>
