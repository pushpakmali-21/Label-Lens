...
export default function VisionInspector() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3 bg-panel p-3 rounded-lg border border-panel-line">
            ...
            {selectedPack.boxes.map((box) => (
              <div
                ...
                className={`flex items-center gap-2 p-1.5 rounded text-[11px] font-mono cursor-pointer transition-all border ${activeBoxId === box.id
                    ? "bg-panel-raised border-brass"
                    : "bg-panel-darker border-panel-line text-text-2"
                  }`}
              >
          ...
          <div className="bg-panel border border-panel-line rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs font-mono pt-1">
              ...
              <div className="p-2.5 bg-panel-darker rounded border border-panel-line">
                ...
                <div className="text-base font-bold text-brass mt-0.5">
            ...
            <div
              className={`p-3 rounded border text-xs leading-relaxed flex items-start gap-2.5 ${isFontCompliant
                  ? "bg-status-pass/10 border-status-pass/30 text-text-1"
                  : "bg-status-fail/10 border-status-fail/30 text-text-1"
                }`}
            >
              {isFontCompliant ? (
